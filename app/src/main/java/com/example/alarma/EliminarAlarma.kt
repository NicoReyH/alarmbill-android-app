...
class EliminarAlarma : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.eliminaralarma)

        val btn: ImageButton = findViewById<ImageButton>(R.id.back_button_to_alarms3)
        btn.setOnClickListener {
            val intent = Intent(this,Alarmas::class.java)
            startActivity(intent)}

        val btn2: Button = findViewById<Button>(R.id.eliminar_alarma2)
        ...
        val options = arrayOf("Electricidad", "Agua", "Internet", "Gas", "Celular")
